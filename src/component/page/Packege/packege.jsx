...
const MultiCarousel = () => {
    ...
    function getImages(params) {
        ...
        fetch("http://26.207.100.35:9090/post", requestOptions)
        ...
        >
            {trips.map((item, index) => (
                <div key={index} className="flex h-[450px]   flex-col items-start p-4 sm:ml-[50px] lg:ml-20 sm:w-full lg:w-full">
                    <Image height={260} width={250} src={item.photoPath} className="w-[280px] h-[200px] rounded-lg object-cover shadow-lg" />
                    <h2 className="mt-4 text-left text-xl font-semibold">{item.title}</h2>
